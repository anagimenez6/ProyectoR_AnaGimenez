...
demografia2 <- melt(demografia, id.vars = c("ano", "nacimientos", "fallecidos"))
demografia2 <- melt(demografia2, id.vars = c("ano", "nacimientos", "fallecidos", "value"))
colnames(demografia2) <- c("ano", "genero", "población según genero", "nacimientos vs. fallecidos", "Variación población")
...
ggplot(demografia, aes(x = ano, y = nacimientos)) +
  geom_point(color = "darkred", fill = "white", size = 5) + 
  theme_clean() +
  labs(
